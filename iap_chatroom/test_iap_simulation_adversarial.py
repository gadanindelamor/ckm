"""
test_iap_simulation_adversarial.py — IAP Simulation Test: Adversarial Debate.
...
Uso:
    python iap_chatroom/test_iap_simulation_adversarial.py
"""
...
DEVICES = {
    PRO_CONTROL: {"device_type": "AI", "system_prompt": PRO_CONTROL_SYSTEM, "provider": None},
    ANTI_CONTROL: {"device_type": "AI", "system_prompt": ANTI_CONTROL_SYSTEM, "provider": None},
}
