...
dynamics across agents and corpora. Neither subsumes the other.
...
| R26 | STOP (field-level, on Δ_r) ≠ TEMP_SIGNAL (agent-level, behavioral instruction). | Verificable |
...
Resisted — CKM does not resolve them. It inhabits the space they left
open.]*
